...
class TeacherInformationPage extends StatefulWidget {
  ...
  const TeacherInformationPage({super.key, required this.teacherId});
...
class _TeacherInformationPageState extends State<TeacherInformationPage> {
  ...
  Future<void> _loadTeacherInfo() async {
    final url = Uri.parse(
      "${ApiConfig.baseUrl}/get_teacher.php?id=${widget.teacherId}",
    );
    try {
  ...
  Widget build(BuildContext context) {
    ...
    final teacherName = teacherInfo?['teacherName'] ?? 'Unknown';
    final phone = teacherInfo?['teacherPhone'] ?? '-';
    final dob = teacherInfo?['teacherDOB'] ?? '-';
    final profileImageUrl = teacherInfo?['profile_image'];
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _infoRow(Icons.badge, 'Teacher ID', widget.teacherId),
