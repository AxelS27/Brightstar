...
class StudentInformationPage extends StatefulWidget {
  ...
  const StudentInformationPage({super.key, required this.studentId});
...
class _StudentInformationPageState extends State<StudentInformationPage> {
  ...
  Future<void> _uploadProfileImage() async {
    ...
    try {
      ...
      request.fields['user_id'] = widget.studentId;
      request.files.add(
  ...
  Widget build(BuildContext context) {
    ...
    final studentName = studentInfo?['studentName'] ?? 'Unknown';
    final phone = studentInfo?['studentPhone'] ?? '-';
    final dob = studentInfo?['studentDOB'] ?? '-';
    final gradeLevel = studentInfo?['gradeLevel'] ?? '-';
    final profileImageUrl = studentInfo?['profile_image'];
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _infoRow(Icons.badge, 'Student ID', widget.studentId),
                          _infoRow(Icons.cake, 'Birthdate', dob),
                          _infoRow(Icons.school, 'Grade Level', gradeLevel),
